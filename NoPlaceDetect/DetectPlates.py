...
from NoPlaceDetect import GetPlateNumber
import random

from NoPlaceDetect import Preprocess
from NoPlaceDetect import DetectChars
from NoPlaceDetect import PossiblePlate
from NoPlaceDetect import PossibleChar
...
def detectPlatesInScene(imgOriginalScene):
    ...
    if GetPlateNumber.showSteps == True:  # show steps #######################################################
    ...
    if GetPlateNumber.showSteps == True:  # show steps #######################################################
        ...
        cv2.drawContours(imgContours, contours, -1, GetPlateNumber.SCALAR_WHITE)
    ...
    if GetPlateNumber.showSteps == True:  # show steps #######################################################
        ...
        for i in range(0, len(listOfPossiblePlates)):
            ...
            cv2.line(imgContours, tuple(p2fRectPoints[0]), tuple(p2fRectPoints[1]), GetPlateNumber.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[1]), tuple(p2fRectPoints[2]), GetPlateNumber.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[2]), tuple(p2fRectPoints[3]), GetPlateNumber.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[3]), tuple(p2fRectPoints[0]), GetPlateNumber.SCALAR_RED, 2)
...
def findPossibleCharsInScene(imgThresh):
    ...
    for i in range(0, len(contours)):  # for each contour
        ...
        if GetPlateNumber.showSteps == True:  # show steps ###################################################
            cv2.drawContours(imgContours, contours, i, GetPlateNumber.SCALAR_WHITE)
        # end if # show steps #####################################################################
