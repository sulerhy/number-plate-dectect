...
import sys
import CONST
import test_cascade_method.run as important_info
...
def main():
    ...
    for i in range(0, min(cars_no, CONST.MAX_PROPOSED_OBJECTS)):
        ...
        # todo Hoang test for adding: casades to detect number plate rough
        _utils.show_img("car_box",car_box)
        # car_box = (important_info.detectPlatePossible(car_box))[0]
